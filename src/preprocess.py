...
def truncate_pad(tokenized_texts, max_length=256, padding_token="[PAD]".lower()):
    ...
    return [
        tokens[:max_length] + (padding_token,) *
        max(0, max_length - len(tokens))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--train-texts", type=str,
                        help="Path to the prepared train texts file.")
    parser.add_argument("--train-labels", type=str,
                        help="Path to the training labels file.")
    parser.add_argument("--val-texts", type=str,
                        help="Path to the prepared validation texts file.")
    parser.add_argument("--val-labels", type=str,
                        help="Path to the validation labels file.")
    parser.add_argument("--test-texts", type=str,
                        help="Path to the prepared test texts file.")
    ...
    parser.add_argument("--pretrained-vocab", type=str,
                        help="Path to the pretrained vocab.")
    parser.add_argument("--pretrained-embed", type=str,
    ...
    train_tokenized = truncate_pad(train_tokenized, max_length=args.max_tokens)
    ...
    val_tokenized = truncate_pad(val_tokenized, max_length=args.max_tokens)
    ...
    test_tokenized = truncate_pad(test_tokenized, max_length=args.max_tokens)
