...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(
        description="Compute evaluation metrics from model output and targets.")
    parser.add_argument("--model-output", type=str,
                        help="Path to the model output generated by the predict.py script.")
    parser.add_argument("--sparse-targets", type=str,
                        help="Path to the sparse targets generated by the predict.py script.")
    ...
    print(
        f"Evaluating completed. Elapsed time: {str(timedelta(seconds=time.time() - t0)).split('.', 2)[0]}")
