...
results_dir=./results/EURLEX57K_full_mil_inter_min10_only
...
--label-tree $preprocessed_dir/flat_label_tree_min10.pkl \
...
# --vocab $preprocessed_dir/vocab.json \
# --embed $preprocessed_dir/vectors.npy \
# --label-tree $preprocessed_dir/flat_label_tree_all.pkl \
# --output-dir $results_dir \
